...
def main():
    podcast_file_name = download_podcast(url='https://www.youtube.com/watch?v=J5O5iRpLXKY&t=637s')
...
def recognize_text(podcast_file_name):
    ...
    for i in [1]:
        ...
        t2 = 200 * 1000
        new_audio = AudioSegment.from_wav(os.path.join(DATA_DIR, podcast_file_name))
